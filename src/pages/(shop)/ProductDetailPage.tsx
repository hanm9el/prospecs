  ...
  return (
    <div className={twMerge(["bg-gray-50", "p-5", "rounded-sm"])}>
      <div className={twMerge(["flex", "justify-between", "items-center", "mb-4"])}>
        ...
        <div
          className={twMerge(["flex", "items-center"], ["bg-white", "border", "border-gray-300"])}
        >
          <button
            className={twMerge(
          ...
          <span className={twMerge(["w-10", "h-8", "flex", "justify-center", "items-center"])}>
            {quantity}
          </span>
          <button
            className={twMerge(
    ...
    <table className={twMerge(["w-full", "text-xs", "text-left"])}>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td className="py-3 text-gray-600 leading-relaxed">{product.careInstructions || "-"}</td>
        </tr>
        <tr>
